...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table 'admins', unsigned: true, force: :cascade do |t|
  ...
  create_table 'disciplinas', primary_key: 'cod_disciplina', unsigned: true, default: nil, force: :cascade do |t|
  ...
  create_table 'migrations', unsigned: true, force: :cascade do |t|
    t.string 'migration', null: false
    t.integer 'batch', null: false
  end

  create_table 'monitoria', unsigned: true, force: :cascade do |t|
  ...
  create_table 'professors', unsigned: true, force: :cascade do |t|
    t.string 'name', null: false
  ...
  create_table 'users', primary_key: ['id', 'matricula'], force: :cascade do |t|
